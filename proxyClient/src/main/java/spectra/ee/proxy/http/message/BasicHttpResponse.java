...
import spectra.ee.proxy.http.ReasonPhraseCatalog;
...
public class BasicHttpResponse extends AbstractHttpMessage implements HttpResponse
{
     ...
     * @param catalog the reason phrase catalog, or <code>null</code> to disable automatic reason phrase lookup
     * @param locale the locale for looking up reason phrases, or <code>null</code> for the system locale
     */
    ...
    /**
     * Creates a response from a status line. The response will not have a reason phrase catalog and use the system
     * default locale.
     *
     * @param statusline the status line
     */
    ...
    /**
     * Creates a response from elements of a status line. The response will not have a reason phrase catalog and use the
     * system default locale.
     *
     * @param ver the protocol version of the response
     * @param code the status code of the response
     * @param reason the reason phrase to the status code, or <code>null</code>
     */
    ...
    /**
     * Looks up a reason phrase. This method evaluates the currently set catalog and locale. It also handles a missing
     * catalog.
     *
