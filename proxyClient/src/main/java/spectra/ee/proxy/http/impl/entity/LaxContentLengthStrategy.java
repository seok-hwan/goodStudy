 ...
 * malformed <code>Content-Length</code> header values.
 * <p/>
...
public class LaxContentLengthStrategy implements ContentLengthStrategy
{
    ...
    /**
     * Creates <tt>LaxContentLengthStrategy</tt> instance with the given length used per default when content length is
     * not explicitly specified in the message.
     *
    ...
    /**
     * Creates <tt>LaxContentLengthStrategy</tt> instance. {@link ContentLengthStrategy#IDENTITY} is used per default
