...
/**
 * Abstract cookie specification which can delegate the job of parsing, validation or matching cookie attributes to a
 * number of arbitrary {@link CookieAttributeHandler}s.
 *
 * @since 4.0
 */
@NotThreadSafe
...
public abstract class AbstractCookieSpec implements CookieSpec
{
    ...
    /**
     * Finds an attribute handler {@link CookieAttributeHandler} for the given attribute. Returns <tt>null</tt> if no
     * attribute handler is found for the specified attribute.
     *
