...
public interface CookieSpec
{
    ...
    /**
     * Returns a request header identifying what version of the state management specification is understood. May be
     * <code>null</code> if the cookie specification does not support <tt>Cookie2</tt> header.
     */
