...
import spectra.ee.proxy.http.cookie.CookieAttributeHandler;
...
import spectra.ee.proxy.http.cookie.SetCookie;
...
public class RFC2965PortAttributeHandler implements CookieAttributeHandler
{
     ...
     * @throws MalformedCookieException if there is a problem in parsing due to invalid portValue.
     */
     ...
     * @return true returns <tt>true</tt> if the given port exists in the given ports list; <tt>false</tt> otherwise.
     */
    ...
    /**
     * Validate cookie port attribute. If the Port attribute was specified in header, the request port must be in
     * cookie's port list.
     */
    ...
    /**
     * Match cookie port attribute. If the Port attribute is not specified in header, the cookie can be sent to any
     * port. Otherwise, the request port must be in the cookie's port list.
     */
