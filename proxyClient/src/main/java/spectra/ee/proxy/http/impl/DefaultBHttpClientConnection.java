...
import spectra.ee.proxy.http.impl.io.DefaultHttpRequestWriterFactory;
import spectra.ee.proxy.http.impl.io.DefaultHttpResponseParserFactory;
import spectra.ee.proxy.http.io.HttpMessageParser;
import spectra.ee.proxy.http.io.HttpMessageParserFactory;
import spectra.ee.proxy.http.io.HttpMessageWriter;
import spectra.ee.proxy.http.io.HttpMessageWriterFactory;
