...
import spectra.ee.proxy.http.message.BasicHeaderElement;
import spectra.ee.proxy.http.message.BasicHeaderValueFormatter;
...
/**
 * Cookie specification that strives to closely mimic (mis)behavior of common web browser applications such as Microsoft
