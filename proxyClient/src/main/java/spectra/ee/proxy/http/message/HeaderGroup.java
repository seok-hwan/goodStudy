...
/**
 * A class for combining a set of headers. This class allows for multiple headers with the same name and keeps track of
 * the order in which headers were added.
 *
 * @since 4.0
 */
@NotThreadSafe
public class HeaderGroup implements Cloneable, Serializable
{
    ...
    /**
     * Sets all of the headers contained within this group overriding any existing headers. The headers are added in the
    ...
    /**
     * Gets a header representing all of the header values with the given name. If more that one header with the given
     * name exists the values will be combined with a "," as per RFC 2616.
     * <p>
    ...
    /**
     * Gets all of the headers with the given name. The returned array maintains the relative order in which the headers
     * were added.
     * <p>
     * Header name comparison is case insensitive.
     *
