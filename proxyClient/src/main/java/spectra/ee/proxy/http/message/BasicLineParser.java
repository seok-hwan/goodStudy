...
/**
 * Basic parser for lines in the head section of an HTTP message. There are individual methods for parsing a request
 * line, a status line, or a header line. The lines to parse are passed in memory, the parser does not depend on any
 * specific IO mechanism. Instances of this class are stateless and thread-safe. Derived classes MUST maintain these
 * properties.
 * <p>
 * Note: This class was created by refactoring parsing code located in various other classes. The author tags from those
 * other classes have been replicated here, although the association with the parsing code taken from there has not been
 * traced.
 * </p>
 *
 * @since 4.0
...
public class BasicLineParser implements LineParser
{
    ...
    /**
     * A default instance of this class, for use as default or fallback. Note that {@link BasicLineParser} is not a
     ...
     *
     * @param proto a version of the protocol to parse, or <code>null</code> for HTTP. The actual version is not
     *            relevant, only the protocol name.
     */
