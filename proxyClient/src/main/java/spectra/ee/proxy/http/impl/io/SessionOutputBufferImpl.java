...
/**
 * Abstract base class for session output buffers that stream data to an arbitrary {@link OutputStream}. This class
 * buffers small chunks of output data in an internal byte array for optimal output performance. </p>
 * {@link #writeLine(CharArrayBuffer)} and {@link #writeLine(String)} methods of this class use CR-LF as a line
 * delimiter.
 *
 * @since 4.3
 */
...
public class SessionOutputBufferImpl implements SessionOutputBuffer, BufferInfo
{
     ...
     * @param fragementSizeHint fragment size hint defining a minimal size of a fragment that should be written out
     *            directly to the socket bypassing the session buffer. Value <code>0</code> disables fragment buffering.
     * @param charencoder charencoder to be used for encoding HTTP protocol elements. If <code>null</code> simple type
     *            cast will be used for char to byte conversion.
     */
