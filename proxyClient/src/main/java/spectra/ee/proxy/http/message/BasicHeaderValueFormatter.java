...
import spectra.ee.proxy.http.HeaderElement;
...
/**
 * Basic implementation for formatting header value elements. Instances of this class are stateless and thread-safe.
...
public class BasicHeaderValueFormatter implements HeaderValueFormatter
{
    ...
    /**
     * A default instance of this class, for use as default or fallback. Note that {@link BasicHeaderValueFormatter} is
     * not a singleton, there can be many instances of the class itself and of derived classes. The instance here
     * provides non-customized, default behavior.
     *
    ...
    /**
     * Special characters that can be used as separators in HTTP parameters. These special characters MUST be in a
     * quoted string to be used within a parameter value .
     */
     ...
     * @param quote <code>true</code> to always format with quoted values, <code>false</code> to use quotes only when
     *            necessary
     ...
     * @param quote <code>true</code> to always format with a quoted value, <code>false</code> to use quotes only when
     *            necessary
     * @param formatter the formatter to use, or <code>null</code> for the {@link #INSTANCE default}
    ...
    /**
     * Actually formats the value of a name-value pair. This does not include a leading = character. Called from
     * {@link #formatNameValuePair formatNameValuePair}.
     *
     * @param buffer the buffer to append to, never <code>null</code>
     * @param value the value to append, never <code>null</code>
     * @param quote <code>true</code> to always format with quotes, <code>false</code> to use quotes only when necessary
     */
     ...
     * @return <code>true</code> if the character is a separator, <code>false</code> otherwise
     */
     ...
     *
     * @param ch the character to check
     * @return <code>true</code> if the character is unsafe, <code>false</code> otherwise
     */
