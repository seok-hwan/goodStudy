...
import spectra.ee.proxy.http.FormattedHeader;
 ...
 * formatting does <i>not</i> include the trailing line break sequence CR-LF. The formatted lines are returned in
 * memory, the formatter does not depend on any specific IO mechanism. Instances of this interface are expected to be
...
public class BasicLineFormatter implements LineFormatter
{
    ...
    /**
     * A default instance of this class, for use as default or fallback. Note that {@link BasicLineFormatter} is not a
     * singleton, there can be many instances of the class itself and of derived classes. The instance here provides
     * non-customized, default behavior.
     *
     ...
     * @return the cleared argument buffer if there is one, or a new empty buffer that can be used for formatting
     */
     ...
     * @param formatter the formatter to use, or <code>null</code> for the {@link #INSTANCE default}
    ...
    /**
     * Guesses the length of a formatted protocol version. Needed to guess the length of a formatted request or status
     * line.
     *
     * @param version the protocol version to format, or <code>null</code>
     * @return the estimated length of the formatted protocol version, in characters
     */
     ...
     *
     * @param buffer the empty buffer into which to format, never <code>null</code>
