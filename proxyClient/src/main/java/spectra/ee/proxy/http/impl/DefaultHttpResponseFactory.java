...
import spectra.ee.proxy.http.message.BasicHttpResponse;
import spectra.ee.proxy.http.message.BasicStatusLine;
...
public class DefaultHttpResponseFactory implements HttpResponseFactory
{
     ...
     *
     * @param context the context from which to determine the locale, or <code>null</code> to use the default locale
