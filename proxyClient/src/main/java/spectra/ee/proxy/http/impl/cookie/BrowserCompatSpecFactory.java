...
/**
 * {@link CookieSpecProvider} implementation that creates and initializes {@link BrowserCompatSpec} instances.
 *
 * @since 4.0
 */
@Immutable
public class BrowserCompatSpecFactory implements CookieSpecProvider
{
