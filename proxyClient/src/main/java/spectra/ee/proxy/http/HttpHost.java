...
/**
 * Holds all of the variables needed to describe an HTTP connection to a host. This includes remote host name, port and
 * scheme.
 *
 * @since 4.0
 */
...
public final class HttpHost implements Cloneable, Serializable
{
     ...
     * @param port the port number. <code>-1</code> indicates the scheme default port.
     * @param scheme the name of the scheme. <code>null</code> indicates the {@link #DEFAULT_SCHEME_NAME default scheme}
     */
    ...
    /**
     * Returns the inet address if explicitly set by a constructor, <code>null</code> otherwise.
     * 
