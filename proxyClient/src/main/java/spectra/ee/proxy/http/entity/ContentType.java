...
import spectra.ee.proxy.http.Consts;
...
import spectra.ee.proxy.http.message.BasicHeaderValueParser;
...
/**
     ...
     * @param s text
     * @return content type
     * @throws ParseException if the given text does not represent a valid <code>Content-Type</code> value.
    ...
    /**
     * Extracts <code>Content-Type</code> value from {@link HttpEntity} exactly as specified by the
     * <code>Content-Type</code> header of the entity. Returns <code>null</code> if not specified.
     *
