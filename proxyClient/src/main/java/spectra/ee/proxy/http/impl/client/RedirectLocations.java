...
/**
 * This class represents a collection of {@link java.net.URI}s used as redirect locations.
 *
 * @since 4.0
 */
@NotThreadSafe
...
public class RedirectLocations extends AbstractList<Object>
{
     ...
     *
     * @param index index of the location to return
     ...
     * @param element URI to be stored at the specified position
     ...
     * @throws ClassCastException if the element is not a {@link URI}
    ...
    /**
     * Inserts the specified element at the specified position in this list (must be a URI). Shifts the URI currently at
     * that position (if any) and any subsequent URIs to the right (adds one to their indices).
     *
     * @param index index at which the specified element is to be inserted
     * @param element URI to be inserted
    ...
    /**
     * Removes the URI at the specified position in this list. Shifts any subsequent URIs to the left (subtracts one
     * from their indices). Returns the URI that was removed from the list.
     *
