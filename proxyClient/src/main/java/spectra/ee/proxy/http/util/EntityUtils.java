...
public final class EntityUtils
{
     ...
     * @throws IOException if an error occurs while reading the input stream on the existing entity.
     ...
     * @return byte array containing the entity content. May be null if {@link HttpEntity#getContent()} is null.
     * @throws IOException if an error occurs reading the input stream
    ...
    /**
     * Get the entity content as a String, using the provided default character set if none is found in the entity. If
     * defaultCharset is null, the default "ISO-8859-1" is used.
     *
     * @param entity must not be null
     ...
     * @throws IllegalArgumentException if entity is null or if content length > Integer.MAX_VALUE
     * @throws IOException if an error occurs reading the input stream
     * @throws UnsupportedCharsetException Thrown when the named charset is not available in this instance of the Java
     *             virtual machine
     */
    ...
    /**
     * Read the contents of an entity and return it as a String. The content is converted using the character set from
     * the entity (if any), failing that, "ISO-8859-1" is used.
     *
