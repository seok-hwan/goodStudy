...
/**
 * {@link CookieSpecProvider} implementation that creates and initializes {@link RFC2109Spec} instances.
 *
 * @since 4.0
 */
@Immutable
public class RFC2109SpecFactory implements CookieSpecProvider
{
