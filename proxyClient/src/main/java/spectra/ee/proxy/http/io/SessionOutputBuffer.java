...
/**
 * Session output buffer for blocking connections. This interface is similar to OutputStream class, but it also provides
 * methods for writing lines of text.
 * <p>
...
public interface SessionOutputBuffer
{
    ...
    /**
     * Writes <code>len</code> bytes from the specified byte array starting at offset <code>off</code> to this session
     * buffer.
     * <p>
    ...
    /**
     * Writes <code>b.length</code> bytes from the specified byte array to this session buffer.
     *
     * @param b the data.
     * @exception IOException if an I/O error occurs.
     */
    ...
    /**
     * Flushes this session buffer and forces any buffered output bytes to be written out. The general contract of
