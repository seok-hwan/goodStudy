...
package spectra.ee.proxy.http.impl;
...
import spectra.ee.proxy.http.HttpConnection;
import spectra.ee.proxy.http.HttpConnectionMetrics;
import spectra.ee.proxy.http.HttpEntity;
import spectra.ee.proxy.http.HttpException;
import spectra.ee.proxy.http.HttpInetConnection;
...
import spectra.ee.proxy.http.entity.BasicHttpEntity;
import spectra.ee.proxy.http.entity.ContentLengthStrategy;
import spectra.ee.proxy.http.impl.entity.LaxContentLengthStrategy;
import spectra.ee.proxy.http.impl.entity.StrictContentLengthStrategy;
import spectra.ee.proxy.http.impl.io.ChunkedInputStream;
import spectra.ee.proxy.http.impl.io.ChunkedOutputStream;
import spectra.ee.proxy.http.impl.io.ContentLengthInputStream;
import spectra.ee.proxy.http.impl.io.ContentLengthOutputStream;
import spectra.ee.proxy.http.impl.io.HttpTransportMetricsImpl;
import spectra.ee.proxy.http.impl.io.IdentityInputStream;
import spectra.ee.proxy.http.impl.io.IdentityOutputStream;
import spectra.ee.proxy.http.impl.io.SessionInputBufferImpl;
import spectra.ee.proxy.http.impl.io.SessionOutputBufferImpl;
...
import spectra.ee.proxy.http.util.NetUtils;

/**
 * This class serves as a base for all {@link HttpConnection} implementations and provides functionality common to both
 * client and server HTTP connections.
 *
 * @since 4.0
 */
@NotThreadSafe
public class BHttpConnectionBase implements HttpConnection, HttpInetConnection
{
     ...
     * @param chardecoder decoder to be used for decoding HTTP protocol elements. If <code>null</code> simple type cast
     *            will be used for byte to char conversion.
     * @param charencoder encoder to be used for encoding HTTP protocol elements. If <code>null</code> simple type cast
     *            will be used for char to byte conversion.
     * @param constraints Message constraints. If <code>null</code> {@link MessageConstraints#DEFAULT} will be used.
    ...
    /**
     * Binds this connection to the given {@link Socket}. This socket will be used by the connection to send and receive
     * data.
     * <p/>
     * After this method's execution the connection status will be reported as open and the {@link #isOpen()} will
