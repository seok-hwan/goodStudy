...
/**
 * Provides directions on establishing a route. Implementations of this interface compare a planned route with a tracked
 * route and indicate the next step required.
 *
 * @since 4.0
 */
public interface HttpRouteDirector
{
     ...
     * @return one of the constants defined in this interface, indicating either the next step to perform, or success, or
