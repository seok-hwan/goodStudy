...
import spectra.ee.proxy.http.client.utils.DateUtils;
...
import spectra.ee.proxy.http.cookie.CookiePathComparator;
import spectra.ee.proxy.http.cookie.CookieRestrictionViolationException;
...
/**
 * RFC 2109 compliant {@link org.apache.http.cookie.CookieSpec} implementation. This is an older version of the official
 * HTTP state management specification superseded by RFC 2965.
 *
 * @see RFC2965Spec
 * @since 4.0
 */
...
public class RFC2109Spec extends CookieSpecBase
{
    ...
    private final static String[] DATE_PATTERNS = {DateUtils.PATTERN_RFC1123, DateUtils.PATTERN_RFC1036, DateUtils.PATTERN_ASCTIME};
    ...
    /**
     * Return a name/value string suitable for sending in a <tt>"Cookie"</tt> header as defined in RFC 2109 for backward
     * compatibility with cookie version 0
     * 
    ...
    /**
     * Return a string suitable for sending in a <tt>"Cookie"</tt> header as defined in RFC 2109 for backward
     * compatibility with cookie version 0
     * 
     * @param buffer The char array buffer to use for output
