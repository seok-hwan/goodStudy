 ...
 * <p>
 * This class defines a protocol version as a combination of protocol name, major version number, and minor version
 * number. Note that {@link #equals} and {@link #hashCode} are defined as final here, they cannot be overridden in
 * derived classes.
 * </p>
 *
 * @since 4.0
...
public class ProtocolVersion implements Serializable, Cloneable
{
    ...
    /**
     * Obtains a specific version of this protocol. This can be used by derived classes to instantiate themselves
     * instead of the base class, and to define constants for commonly used versions. <br/>
     * The default implementation in this class returns <code>this</code> if the version matches, and creates a new
     * {@link ProtocolVersion} otherwise.
     *
    ...
    /**
     * Checks equality of this protocol version with an object. The object is equal if it is a protocl version with the
     * same protocol name, major version number, and minor version number. The specific class of the object is
     * <i>not</i> relevant, instances of derived classes with identical attributes are equal to instances of the base
    ...
    /**
     * Checks whether this protocol can be compared to another one. Only protocol versions with the same protocol name
     * can be {@link #compareToVersion compared}.
     *
     * @param that the protocol version to consider
     * @return <code>true</code> if {@link #compareToVersion compareToVersion} can be called with the argument,
    ...
    /**
     * Compares this protocol version with another one. Only protocol versions with the same protocol name can be
     * compared. This method does <i>not</i> define a total ordering, as it would be required for
     ...
     * @throws IllegalArgumentException if the argument has a different protocol name than this object, or if the
     ...
     * @return <code>true</code> if this protocol version is {@link #isComparable comparable} to the argument and
     *         {@link #compareToVersion compares} as greater or equal, <code>false</code> otherwise
     */
     ...
     * @param version the version against which to check this version
     * @return <code>true</code> if this protocol version is {@link #isComparable comparable} to the argument and
     *         {@link #compareToVersion compares} as less or equal, <code>false</code> otherwise
     */
