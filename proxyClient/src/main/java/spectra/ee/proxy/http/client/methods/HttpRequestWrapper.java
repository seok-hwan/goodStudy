...
import spectra.ee.proxy.http.message.AbstractHttpMessage;
import spectra.ee.proxy.http.message.BasicRequestLine;
import spectra.ee.proxy.http.protocol.HTTP;

/**
 * A wrapper class for {@link HttpRequest} that can be used to change properties of the current request without
