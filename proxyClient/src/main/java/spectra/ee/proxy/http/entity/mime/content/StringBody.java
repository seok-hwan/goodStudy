...
import spectra.ee.proxy.http.entity.mime.MIME;
...
public class StringBody extends AbstractContentBody
{
    ...
    /**
     * @since 4.1
     * @deprecated (4.3) use {@link StringBody#StringBody(String, ContentType)} or
    ...
    /**
     * Create a StringBody from the specified text. The MIME type is set to "text/plain". The {@linkplain Consts#ASCII
     * ASCII} charset is used.
     *
     * @param text to be used for the body, not {@code null}
     * @throws UnsupportedEncodingException
     * @throws IllegalArgumentException if the {@code text} parameter is null
