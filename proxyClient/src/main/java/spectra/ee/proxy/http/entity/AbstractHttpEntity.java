...
package spectra.ee.proxy.http.entity;
...
public abstract class AbstractHttpEntity implements HttpEntity
{
    ...
    /**
     * Protected default constructor. The contentType, contentEncoding and chunked attributes of the created object are
     * set to <code>null</code>, <code>null</code> and <code>false</code>, respectively.
     */
    ...
    /**
     * Obtains the Content-Type header. The default implementation returns the value of the {@link #contentType
    ...
    /**
     * Obtains the Content-Encoding header. The default implementation returns the value of the {@link #contentEncoding
    ...
    /**
     * Obtains the 'chunked' flag. The default implementation returns the value of the {@link #chunked chunked}
     * attribute.
     *
     ...
     * contentType} attribute.
     *
     * @param contentType the new Content-Encoding header, or <code>null</code> to unset
     */
     ...
     *
     * @param ctString the new Content-Type header, or <code>null</code> to unset
     */
    ...
    /**
     * Specifies the Content-Encoding header. The default implementation sets the value of the {@link #contentEncoding
     * contentEncoding} attribute.
     *
     * @param contentEncoding the new Content-Encoding header, or <code>null</code> to unset
     */
    ...
    /**
     * Specifies the Content-Encoding header, as a string. The default implementation calls
     * {@link #setContentEncoding(Header) setContentEncoding(Header)}.
     *
     * @param ceString the new Content-Encoding header, or <code>null</code> to unset
     */
     ...
     * <p>
     * Note that the chunked setting is a hint only. If using HTTP/1.0, chunking is never performed. Otherwise, even if
     * chunked is false, HttpClient must use chunk coding if the entity content length is unknown (-1).
     * <p>
