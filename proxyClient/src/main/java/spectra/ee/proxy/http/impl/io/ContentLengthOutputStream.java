...
/**
 * Output stream that cuts off after a defined number of bytes. This class is used to send content of HTTP messages
...
public class ContentLengthOutputStream extends OutputStream
{
     ...
     * @param contentLength The maximum number of bytes that can be written to the stream. Subsequent write operations
     *            will be ignored.
     * @since 4.0
     */
