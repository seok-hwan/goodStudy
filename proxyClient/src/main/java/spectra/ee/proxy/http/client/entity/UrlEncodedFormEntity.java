...
import spectra.ee.proxy.http.client.utils.URLEncodedUtils;
import spectra.ee.proxy.http.entity.ContentType;
import spectra.ee.proxy.http.entity.StringEntity;
...
public class UrlEncodedFormEntity extends StringEntity
{
    ...
    /**
     * Constructs a new {@link UrlEncodedFormEntity} with the list of parameters with the default encoding of
