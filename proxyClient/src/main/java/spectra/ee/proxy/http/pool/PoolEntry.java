...
import spectra.ee.proxy.http.annotation.GuardedBy;
 ...
 * <p/>
 * The connection contained by the pool entry may have an expiration time which can be either set upon construction time
 * or updated with the {@link #updateExpiry(long, TimeUnit)}.
 * <p/>
 * Pool entry may also have an object associated with it that represents a connection state (usually a security
 * principal or a unique token identifying the user whose credentials have been used while establishing the connection).
 *
