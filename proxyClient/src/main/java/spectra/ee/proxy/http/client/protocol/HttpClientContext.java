...
/**
 * Adaptor class that provides convenience type safe setters and getters for common {@link HttpContext} attributes used
 * in the course of HTTP request execution.
 *
 * @since 4.3
 */
@NotThreadSafe
public class HttpClientContext extends HttpCoreContext
{
    ...
    /**
     * Attribute name of a {@link org.apache.http.conn.routing.RouteInfo} object that represents the actual connection
     * route.
     */
    public static final String HTTP_ROUTE = "http.route";

    /**
     * Attribute name of a {@link List} object that represents a collection of all redirect locations received in the
     * process of request execution.
     */
    public static final String REDIRECT_LOCATIONS = "http.protocol.redirect-locations";

    /**
     * Attribute name of a {@link org.apache.http.config.Lookup} object that represents the actual
     * {@link CookieSpecProvider} registry.
     */
    public static final String COOKIESPEC_REGISTRY = "http.cookiespec-registry";

    /**
     * Attribute name of a {@link org.apache.http.cookie.CookieSpec} object that represents the actual cookie
     * specification.
     */
    public static final String COOKIE_SPEC = "http.cookie-spec";

    /**
     * Attribute name of a {@link org.apache.http.cookie.CookieOrigin} object that represents the actual details of the
     * origin server.
     */
    public static final String COOKIE_ORIGIN = "http.cookie-origin";

    /**
     * Attribute name of a {@link org.apache.http.client.CookieStore} object that represents the actual cookie store.
     */
    public static final String COOKIE_STORE = "http.cookie-store";

    /**
     * Attribute name of a {@link org.apache.http.client.AuthCache} object that represents the auth scheme cache.
     */
    public static final String AUTH_CACHE = "http.auth.auth-cache";

    /**
     * Attribute name of a {@link java.lang.Object} object that represents the actual user identity such as user
    ...
    /**
     * Attribute name of a {@link org.apache.http.config.Lookup} object that represents the actual
     * {@link AuthSchemeProvider} registry.
     */
    public static final String AUTHSCHEME_REGISTRY = "http.authscheme-registry";

    /**
     * Attribute name of a {@link org.apache.http.client.config.RequestConfig} object that represents the actual request
     * configuration.
     */
