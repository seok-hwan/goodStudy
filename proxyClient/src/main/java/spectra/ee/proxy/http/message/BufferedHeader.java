...
/**
 * This class represents a raw HTTP header whose content is parsed 'on demand' only when the header value needs to be
 * consumed.
 *
 * @since 4.0
 */
...
public class BufferedHeader implements FormattedHeader, Cloneable, Serializable
{
    ...
    /**
     * Creates a new header from a buffer. The name of the header will be parsed immediately, the value only if it is
     * accessed.
     *
