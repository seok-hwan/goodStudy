...
/**
 * {@link CookieSpecProvider} implementation that creates and initializes {@link RFC2965Spec} instances.
 *
 * @since 4.0
 */
@Immutable
public class RFC2965SpecFactory implements CookieSpecProvider
{
