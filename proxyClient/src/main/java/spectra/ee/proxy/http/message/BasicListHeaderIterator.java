...
public class BasicListHeaderIterator implements HeaderIterator
{
    ...
    /**
     * The header name to filter by. <code>null</code> to iterate over all headers in the array.
     */
     ...
     * @param name the name of the headers over which to iterate, or <code>null</code> for any
     */
     ...
     * @return the index of the next header that matches the filter name, or negative if there are no more headers
     */
     ...
     * @return <code>true</code> if the header should be part of the iteration, <code>false</code> to skip
     */
