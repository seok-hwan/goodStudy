...
/**
 * {@link CookieSpecProvider} implementation that creates and initializes {@link BestMatchSpec} instances.
 *
 * @since 4.0
 */
@Immutable
public class BestMatchSpecFactory implements CookieSpecProvider
{
