...
import spectra.ee.proxy.http.entity.mime.content.ByteArrayBody;
import spectra.ee.proxy.http.entity.mime.content.ContentBody;
import spectra.ee.proxy.http.entity.mime.content.FileBody;
import spectra.ee.proxy.http.entity.mime.content.InputStreamBody;
import spectra.ee.proxy.http.entity.mime.content.StringBody;
