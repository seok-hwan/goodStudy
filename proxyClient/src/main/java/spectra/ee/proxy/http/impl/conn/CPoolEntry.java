...
import spectra.ee.proxy.http.pool.PoolEntry;
...
class CPoolEntry extends PoolEntry<HttpRoute, ManagedHttpClientConnection>
{
    ...
    public CPoolEntry(final String id, final HttpRoute route, final ManagedHttpClientConnection conn, final long timeToLive, final TimeUnit tunit)
    {
    ...
    public boolean isExpired(final long now)
    {
        ...
        {
            logger.debug("Connection " + this + " expired @ " + new Date(getExpiry()));
        }
        return expired;
    }
