...
import spectra.ee.proxy.http.entity.mime.content.AbstractContentBody;
import spectra.ee.proxy.http.entity.mime.content.ContentBody;
import spectra.ee.proxy.http.util.Args;

/**
 * FormBodyPart class represents a content body that can be used as a part of multipart encoded entities. This class
 * automatically populates the header with standard fields based on the content description of the enclosed body.
 *
 * @since 4.0
 */
