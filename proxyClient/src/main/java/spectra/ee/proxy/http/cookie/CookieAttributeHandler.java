...
/**
 * This interface represents a cookie attribute handler responsible for parsing, validating, and matching a specific
 * cookie attribute, such as path, domain, port, etc. Different cookie specifications can provide a specific
 * implementation for this class based on their cookie handling rules.
 *
 * @since 4.0
 */
public interface CookieAttributeHandler
{
    ...
    /**
     * Parse the given cookie attribute value and update the corresponding {@link org.apache.http.cookie.Cookie}
     * property.
     *
     ...
     * corresponding cookie attribute.
     *
