...
public interface ContentLengthStrategy
{
    ...
    /**
     * Returns length of the given message in bytes. The returned value must be a non-negative number, {@link #IDENTITY}
     * if the end of the message will be delimited by the end of connection, or {@link #CHUNKED} if the message is chunk
     * coded
     *
