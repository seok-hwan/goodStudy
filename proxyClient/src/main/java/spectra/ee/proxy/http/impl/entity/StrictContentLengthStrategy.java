...
package spectra.ee.proxy.http.impl.entity;
...
/**
 * The strict implementation of the content length strategy. This class will throw {@link ProtocolException} if it
 * encounters an unsupported transfer encoding or a malformed <code>Content-Length</code> header value.
 * <p>
...
public class StrictContentLengthStrategy implements ContentLengthStrategy
{
    ...
    /**
     * Creates <tt>StrictContentLengthStrategy</tt> instance with the given length used per default when content length
    ...
    /**
     * Creates <tt>StrictContentLengthStrategy</tt> instance. {@link ContentLengthStrategy#IDENTITY} is used per default
