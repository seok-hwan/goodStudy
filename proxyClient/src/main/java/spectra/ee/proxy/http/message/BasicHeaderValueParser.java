...
/**
 * Basic implementation for parsing header values into elements. Instances of this class are stateless and thread-safe.
...
public class BasicHeaderValueParser implements HeaderValueParser
{
    ...
    /**
     * A default instance of this class, for use as default or fallback. Note that {@link BasicHeaderValueParser} is not
     * a singleton, there can be many instances of the class itself and of derived classes. The instance here provides
