...
/**
 * HttpStrictMultipart represents a collection of MIME multipart encoded content bodies, implementing the strict (RFC
 * 822, RFC 2045, RFC 2046 compliant) interpretation of the spec.
 *
 * @since 4.3
 */
